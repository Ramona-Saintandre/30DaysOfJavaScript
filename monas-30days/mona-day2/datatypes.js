...
// 7. Use substr to slice out the phrase because because because in the following sentence:
...
console.log(company.brandsArray.split(','));
// 12. Change 30 Days Of JavaScript to Microsoft Academy using replace() method.
...
console.log
// 19Use search to find the position of the first occurrence of the word because in the following sentence:
//'You cannot end a sentence with because because because is a conjunction'


console.log
// 20.Use trim() to remove if there is trailing whitespace at the beginning and the end of a string.E.g 
